function renderAboutUs(parentId) {
    ...
    AboutUsContainer.innerHTML = `
        ...
        <div>
            ...
            <div>
                <p>Möt vårt team:</p>
                <p>Olivia: Webbutvecklare och webbdesigner. Favoritmaträtt: </p>
                <p>[Klasskamrat 1]: Webbutvecklare och webbdesigner. Favoritmaträtt: </p>
                <p>[Klasskamrat 2]: Webbutvecklare och webbdesigner. Favoritmaträtt: </p>
                <p>[Klasskamrat 3]: Webbutvecklare och webbdesigner. Favoritmaträtt: </p>
            </div>
